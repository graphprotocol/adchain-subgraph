...
class Registry__challengesResult {
  value0: U256;
  value1: Address;
  value2: boolean;
  value3: U256;
...
class Registry__listingsResult {
  value0: U256;
  value1: boolean;
  value2: Address;
  value3: U256;
...
class Registry extends SmartContract {
  static bind(address: Address, blockHash: H256): Registry {
    return new Registry("Registry", address, blockHash);
  }
